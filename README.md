...
- a 12&nbsp;V to 5&nbsp;V regulator: the 3D printed parts are designed for one of [these](https://www.aliexpress.com/item/1005010692851197.html), you could of course modify them to take any small regulator board; the current requirements for the 5&nbsp;V supply are negligible,
...
- a 12&nbsp;V, 2&nbsp;or-more-Amp, centre-positive plug-top power supply terminating in a 2.1&nbsp;mm&nbsp;x&nbsp;5.5&nbsp;mm connector,
...
- hook the 3D printed wheel over the handle of the plinky-plonky mechanism then, with the grub screw hole and the flat on the stepper motor spindle uppermost, push the stepper motor spindle into the centre of the 3D printed wheel from the other side of its mounting bracket (i.e. so the spindle goes through the large central hole in the motor mounting bracket) and, as you do so, pass the stepper motor wires through the hole in the bottom left of the bracket and into the area of the 3D printed body where the boards will be mounted,
